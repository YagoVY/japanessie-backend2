...
const FONT_PATHS = {
  ...
  'kiwi-maru': path.join(__dirname, '../../assets/fonts/KiwiMaru-Regular.ttf'),
  'klee-one': path.join(__dirname, '../../assets/fonts/KleeOne-Regular.ttf'),
  'mochiy-pop-one': path.join(__dirname, '../../assets/fonts/MochiyPopOne-Regular.ttf'),
  'noto-sans-jp': path.join(__dirname, '../../assets/fonts/NotoSansJP-Black.ttf'),
  'yuji-mai': path.join(__dirname, '../../assets/fonts/YujiMai-Regular.ttf'),
  'noto-sans-cjk': path.join(__dirname, '../../assets/fonts/NotoSansCJKjp-Regular.ttf'),
  'darumadrop-one': path.join(__dirname, '../../assets/fonts/DarumadropOne-Regular.ttf'),
  'fzgonza': path.join(__dirname, '../../assets/fonts/FZGonza.ttf'),
  'aoyagi': path.join(__dirname, '../../assets/fonts/Aoyagi.ttf'),
  'hgheiseikakugow9l': path.join(__dirname, '../../assets/fonts/HGHeiseiKakugoW9L.ttf'),
  's2gmemo': path.join(__dirname, '../../assets/fonts/S2Gmemo.ttf')
};
...
async function ensureFontsLoaded() {
  ...
  try {
    ...
    const fontRegistrations = [
      ...
      { path: FONT_PATHS['kiwi-maru'], family: 'Kiwi Maru' },
      { path: FONT_PATHS['klee-one'], family: 'Klee One' },
      { path: FONT_PATHS['mochiy-pop-one'], family: 'Mochiy Pop One' },
      { path: FONT_PATHS['noto-sans-jp'], family: 'Noto Sans JP' },
      { path: FONT_PATHS['yuji-mai'], family: 'Yuji Mai' },
      { path: FONT_PATHS['noto-sans-cjk'], family: 'Noto Sans CJK JP' },
      { path: FONT_PATHS['darumadrop-one'], family: 'Darumadrop One' },
      { path: FONT_PATHS['fzgonza'], family: 'FZGonza' },
      { path: FONT_PATHS['aoyagi'], family: 'Aoyagi' },
      { path: FONT_PATHS['hgheiseikakugow9l'], family: 'HGHeiseiKakugoW9L' },
      { path: FONT_PATHS['s2gmemo'], family: 'S2Gmemo' }
    ];
